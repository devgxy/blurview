...
object Toolkit {
    ...
    fun blur(
        ...
        require(radius.toInt() in 1..MAX_BLUR_RADIUS) {
            "$externalName blur. The radius should be between 1 and $MAX_BLUR_RADIUS. $radius provided."
        }
     ...
     */
    @JvmOverloads
    fun blur(inputBitmap: Bitmap, radius: Float = 5f, restriction: Range2d? = null): Bitmap {
